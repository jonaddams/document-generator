...
export const ErrorMessages: Record<ErrorCode, string> = {
  [ErrorCodes.TEMPLATE_LOAD_FAILED]: 'Failed to load template. Please try again or select a different template.',
  [ErrorCodes.TEMPLATE_PARSE_FAILED]: 'Template format is invalid. Please check the template file and try again.',
  [ErrorCodes.TEMPLATE_EDITOR_INIT_FAILED]: 'Failed to initialize template editor. Please refresh the page and try again.',
  
  [ErrorCodes.DATA_INVALID_JSON]: 'JSON data is invalid. Please check the syntax and try again.',
  [ErrorCodes.DATA_EDITOR_INIT_FAILED]: 'Failed to initialize data editor. Please refresh the page and try again.',
  [ErrorCodes.DATA_LOAD_FAILED]: 'Failed to load data. Please check the data file and try again.',
  
  [ErrorCodes.DOCX_GENERATION_FAILED]: 'Failed to generate DOCX document. Please check your template and data.',
  [ErrorCodes.DOCX_EDITOR_INIT_FAILED]: 'Failed to initialize document editor. Please try again.',
  [ErrorCodes.PDF_GENERATION_FAILED]: 'Failed to generate PDF. Please try again.',
  [ErrorCodes.PDF_VIEWER_INIT_FAILED]: 'Failed to initialize PDF viewer. Please refresh the page and try again.',
  
  [ErrorCodes.FILE_TOO_LARGE]: 'File size is too large. Please select a file smaller than 10MB.',
  [ErrorCodes.FILE_INVALID_TYPE]: 'Invalid file type. Please select a valid file.',
  [ErrorCodes.FILE_READ_FAILED]: 'Failed to read file. Please try selecting the file again.',
  
  [ErrorCodes.SDK_NOT_LOADED]: 'Required libraries are not loaded. Please refresh the page and try again.',
  [ErrorCodes.SDK_INIT_FAILED]: 'Failed to initialize document processing libraries. Please refresh the page.',
  [ErrorCodes.SDK_OPERATION_FAILED]: 'Document operation failed. Please try again.',
  
  [ErrorCodes.NETWORK_ERROR]: 'Network connection error. Please check your internet connection and try again.',
  [ErrorCodes.FETCH_FAILED]: 'Failed to fetch data. Please check your connection and try again.',
  
  [ErrorCodes.UNKNOWN_ERROR]: 'An unexpected error occurred. Please try again.',
  [ErrorCodes.VALIDATION_ERROR]: 'Validation failed. Please check your input and try again.',
};
...
export function handleError(
  ...
  if (error instanceof Error) {
    ...
    if (errorMessage.includes('sdk') || errorMessage.includes('pspdfkit') || errorMessage.includes('docauth')) {
...
export function shouldShowDetails(error: AppError): boolean {
  ...
  return process.env.NODE_ENV === 'development' || detailsErrorCodes.includes(error.code as ErrorCode);
}